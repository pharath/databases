...
-- change the order of R1 and R2.
-- shows that the order matters!
-- the trigger that was created 2nd is always executed first
-- here: R1 is executed first
...
-- the # numbers indicate the execution order of the triggers
...
for each row
begin
  insert into T2 select avg(A) from T1; -- triggered once immediately after each insert of a row in T1
end;
