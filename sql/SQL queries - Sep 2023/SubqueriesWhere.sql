...
/**************************************************************
  Same as before, but just names of students applying to CS
**************************************************************/
...
/**************************************************************
  Same query written without 'In'
  (we get many copies because a student can apply to 'CS' at
  multiple colleges and is listed multiple times then)
**************************************************************/
...
/**************************************************************
  ...
  (each student can apply to CS multiple times => student
...
/**************************************************************
  ...
  Remember: We can ALWAYS rewrite "Any/All" queries by using "EXISTS/NOT EXISTS" !
**************************************************************/
...
/**************************************************************
  Students who applied to CS but not EE
  Note: It's actually quite tricky to use the any and all operators 
  and always get the right answer. It's especially tricky when you can't 
  just eyeball the answer and check.
**************************************************************/
