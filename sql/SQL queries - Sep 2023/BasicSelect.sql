...
/**************************************************************
  All large campuses (enroll > 20000) with CS applicants
**************************************************************/
...
/**************************************************************
  Application information (sID, sName, GPA, cName, enrollment)
**************************************************************/
...
/**************************************************************
  Applicants (sID, major) to bio majors
**************************************************************/

select sID, major
from Apply
where major like '%bio%'; -- some set of chars, followed by 'bio', followed by some set of chars

/*** Same query with Select asterisk (just to show what asterisk does) ***/
...
/**************************************************************
  Select * cross-product Student, College
**************************************************************/
...
/**************************************************************
  Add scaled GPA based on (sizeHS/1000.0) (Achtung: float nicht int)
