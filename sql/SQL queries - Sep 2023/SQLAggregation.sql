...
/**************************************************************
  ...
  phth: this example shows that you have to be careful with
  which attributes you include in the select clause when you
  aggregate
**************************************************************/
...
/*** Add student name ***/
/*** - the sName in each row is randomly chosen from all ***/
/***   possible sNames in each group ***/
/***   - but since all sNames are the same in each group ***/
...
/*** - the cName in each row is randomly chosen from all ***/
/***   possible cNames in each group ***/
