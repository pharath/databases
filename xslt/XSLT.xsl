...
<!-- phth: Preferred file extension for XSLT documents ? -->
<!-- https://stackoverflow.com/questions/46276059/preferred-file-extension-for-xslt-documents -->
...
<!-- matches any leaf text (cf. example with "*|@*|text()" below) -->
...
<!--*****************************************************************
     ...
     see next examples to see why this is useful
******************************************************************-->
...
<!-- 
This OR-construct here is seen quite frequently in XSLT
specifications to match just anything at all in the data:
- "*", that means any element tag,
- "@*", any attribute,
- "text()", any text leaf of the XML data
-->
<xsl:template match="*|@*|text()">
   <xsl:copy>
...
<!--*****************************************************************
     ...
     (a bit shorter: using one instead of two templates)
******************************************************************-->
